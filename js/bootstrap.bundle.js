...
(function (global, factory) {
  ...
  */
  ...
  const SELECTOR_MENU = '.dropdown-menu.php';
  const SELECTOR_NAVBAR = '.navbar';
  const SELECTOR_NAVBAR_NAV = '.navbar-nav';
  const SELECTOR_VISIBLE_ITEMS = '.dropdown-menu.php .dropdown-item:not(.disabled):not(:disabled)';
    ...
    static clearMenus(event) {
      ...
      for (const toggle of openToggles) {
        ...
        if (composedPath.includes(context._element) || context._config.autoClose === 'inside' && !isMenuTarget || context._config.autoClose === 'outside' && isMenuTarget) {
          continue;
        } // Tab navigation through the dropdown menu.php or events from contained inputs shouldn't close the menu.php
  ...
  class ScrollSpy extends BaseComponent {
    constructor(element, config) {
      super(element, config); // this._element is the observablesContainer and config.target the menu.php links wrapper
  ...
  const SELECTOR_DROPDOWN_MENU = '.dropdown-menu.php';
