...
// конструктор класса, который получает ID, secret, token
    ...
    protected function __construct( $app_id, $app_secret, $access_token = '' ) {
        ...
        // Устанавливает пользователя, если не установлен
    ...
    public function add_rewrite_rules( $wp_rewrite ) {
        ...
        if (function_exists('get_current_screen') && isset(get_current_screen()->base) && get_current_screen()->base != 'options-permalink' ) {
            flush_rewrite_rules();
        }
    }
